...
The \mokka and \ddhep simulations have been checked to give consistent results. In the following, only the results with the \ddhep simulation.
...
The hit energy spectrum has also been checked for electrons. Data and simulation agree rather well within 10\% for energies below 10 MIPs, which is the range of hit energies relevant for this analysis.
...
Figure \ref{fig:dNdt_Data} shows the time of first hit for muons, 10 GeV electrons and 50 GeV pions. The muon and electron distributions centered around 0 ns within a certain time window that is determined by the intrinsic time resolution of the detector. Isolated hits are present in the tails most likely caused by SiPM thermal noise.
