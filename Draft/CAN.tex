...
\begin{figure}[htbp]
	\subfigure[Time of the first hit function of the number of triggered channels in a chip.\label{fig:nhits_profile}] {\includegraphics[width=0.5\textwidth]{fig/Electrons/NumberHits_Dependance.pdf}}\hfill
	\subfigure[RMS of the time of first hit function of the number of triggered channels.\label{fig:RMS_nHits}] {\includegraphics[width=0.5\textwidth]{fig/Electrons/ParametrisationPedestalShift_20GeV.pdf}}
...
\begin{figure}[htbp]
	\subfigure[Time of first hit for data and simulation between -50 and 50 ns.\label{fig:muon_sim_data_1}] {\includegraphics[width=0.5\textwidth]{fig/Muons/Comparison_MokkaDD4hepData_Muons.pdf}}\hfill
	\subfigure[Time of first hit for data and simulation zoomed between 1 and 200 ns.\label{fig:muon_sim_data_2}] {\includegraphics[width=0.5\textwidth]{fig/Muons/Comparison_MokkaDD4hepData_Muons_zoom.pdf}}
...
\begin{figure}[htbp]
	...
	\caption[]{Comparison between electron data and MC for all energies of the number of triggered channels per chip.}
