...
The data is reconstructed using the current CALICE software based on the Marlin framework \cite{}. A cut at 0.5 MIP is applied to individual channels to remove noise hits.
