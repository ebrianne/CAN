...
\begin{figure}[htbp]
	...
	\subfigure[Distribution of the extracted TDC slopes.\label{fig:slope_time}] {\includegraphics[width=0.5\textwidth]{fig/SlopesTDC.pdf}}
...
\begin{figure}[htbp]
	...
	%\subfigure[Profile for chip 146 on layer 09 after the non linearity correction of the ramp.\label{fig:LinCorr_2}]{\includegraphics[width=0.5\textwidth]{fig/ProfileFitLinearity_Corr.eps}}
...
\begin{figure}[htbp]
	\subfigure[Profile of the time of first hit as function of the hit energy.\label{fig:time_walk_corr}] {\includegraphics[width=0.5\textwidth]{fig/TimeWalkProfile.pdf}}\hfill
	%\subfigure[Time of the first hit distribution for layer 3.\label{fig:layer3_time_corr}] {\includegraphics[width=0.5\textwidth]{fig/TimeDistribution_Module3_All.eps}}
...
\begin{figure}[htbp]
	%\subfigure[Distribution of trigger delay offset for electrons.\label{fig:delay_elec}] {\includegraphics[width=0.5\textwidth]{fig/FittedOffsets_electrons.eps}}\hfill
	\subfigure[Time of the first hit distribution with 20 GeV electrons for the AHCAL.\label{fig:Timing_electrons}] {\includegraphics[width=0.5\textwidth]{fig/Electrons_MuonCalib/Timing_AllLayers.pdf}}
...
\begin{figure}[htbp]
	%\subfigure[Time of first hit for data and simulation between -50 and 50 ns.\label{fig:muon_sim_data_1}] {\includegraphics[width=0.5\textwidth]{fig/Comparison_SimData_Muons.eps}}\hfill
	%\subfigure[Time of first hit for data and simulation zoomed between 1 and 200 ns.\label{fig:muon_sim_data_2}] {\includegraphics[width=0.5\textwidth]{fig/Comparison_SimData_Muons_zoom.eps}}
