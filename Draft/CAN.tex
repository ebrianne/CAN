...
%     \caption{10 GeV.}\label{fig:dNdt_SimData_10GeV_DD4hep}
%   \end{subfigure}
%   \hfill
%   \begin{subfigure}[t]{0.49\textwidth}
%     \centering
...
%   \end{subfigure}
%   \caption{Comparison between the \mokka simulation and data of the time of first hit as function of the hit energy for pion beams between 10 GeV and 90 GeV. The grey and color bands shows the systematics.}
% \end{figure}
%
% \begin{figure}[htbp!]
%   \begin{subfigure}[t]{0.49\textwidth}
